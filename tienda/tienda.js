...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
    ...
    <div id="w3lDemoBar" class="w3l-demo-bar">
        ...
        <a href="https://w3layouts.com/checkout/?add-to-cart=42933" class="no-margin-bottom-mobile">
			...
			<div class="inner-sec-shop px-lg-4 px-3">
				...
				<div class="row">
					<div class="col-md-12 middle-slider my-4">
						<div class="middle-text-info ">
							...
							<div class="simply-countdown-custom" id="simply-countdown-custom"><div class="simply-section"><div><span class="simply-amount">31</span><span class="simply-word">days</span></div></div><div class="simply-section"><div><span class="simply-amount">4</span><span class="simply-word">hours</span></div></div><div class="simply-section"><div><span class="simply-amount">56</span><span class="simply-word">minutes</span></div></div><div class="simply-section"><div><span class="simply-amount">29</span><span class="simply-word">seconds</span></div></div></div>
				...
				<div class="slider-img mid-sec">
					...
					<div class="mid-slider">
						<div class="owl-carousel owl-theme row owl-loaded owl-drag">
						...
						<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-924px, 0px, 0px); transition: all 0s ease 0s; width: 3696px;"><div class="owl-item cloned" style="width: 298px; margin-right: 10px;"><div class="item">
							...
							</div></div><div class="owl-item cloned" style="width: 298px; margin-right: 10px;"><div class="item">
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
							...
							</div></div><div class="owl-item active" style="width: 298px; margin-right: 10px;"><div class="item">
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
							...
							</div></div><div class="owl-item" style="width: 298px; margin-right: 10px;"><div class="item">
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
